...
<div class="page-banner">
    ...
    <div class="page-banner__content container t-center c-white">
        <h1 class="headline headline--large">Hello, and Welcome, world!</h1>
...
<div class="hero-slider">
    ...
    <div class="glide__slides">
        ...
        <?php /* get_template_part('template-parts/content', 'homepage-slides'); */ ?>
        <?php $homepageSlideshow = new WP_Query(array(
            'posts_per_page' => -1,
