...
registerBlockType("our-block-theme/slide", {
    title: "Slide",
    supports: { align: ["full"] },
    attributes: {
            ...
            <div className="hero-slider__slide" style={{ backgroundImage: `url('${props.attributes.imgURL}')` }}>
                <div className="hero-slider__interior container">
                    <div className="hero-slider__overlay t-center">
                        <InnerBlocks allowedBlocks={["our-block-theme/generic-heading", "our-block-theme/generic-button"]} />
                    </div>
                </div>
            </div>
        </>
...
function SaveComponent(props) { return <InnerBlocks.Content /> }