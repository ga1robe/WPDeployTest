        ...
        <div class="site-header__menu group">
            <nav class="main-navigation">
                ...
                <ul>
                    ...
                    <li <?php if(get_post_type() == 'campus' ) echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('campus') ?>">Locations<!--Campuses--></a></li>
            ...
            <div class="site-header__util">
                ...
                if(is_user_logged_in()){ ?>
                    ...
                    <a href="<?php echo wp_logout_url() ?>" class="btn btn--small btn--dark-orange float-left btn--with-photo">
                        <spam class="site-header__avatar"><?php echo get_avatar(get_current_user_id(), 60) ?></spam>
                        <spam class="btn__text">Log Out</spam>
                    </a>
                <?php
                } else {
                ?>
